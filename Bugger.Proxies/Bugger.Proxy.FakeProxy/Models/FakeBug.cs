...
namespace Bugger.Proxy.FakeProxy.Models
{
    public class FakeBug : IBug, IEquatable<FakeBug>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FakeBug"/> class.
        /// </summary>
        public FakeBug()
        {
        ...
        public void CheckUpdate(IBug oldModel)
        {
            ...
            if (!(oldModel is FakeBug)) { throw new NotSupportedException("oldModel must be BugViewModel type."); }

            var other = oldModel as FakeBug;
