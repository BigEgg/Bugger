...
{
    [Serializable]
    public class PropertyMappingDictionary : ObservableCollection<Bugger.Proxy.Models.PropertyMappingDictionary.MappingModel>
    {
        #region Properties
        /// <summary>
        ...
        /// <exception cref="System.ArgumentNullException">
        /// key cannot be null or white space.
        /// or
        ...
        {
            if (string.IsNullOrWhiteSpace(key)) { throw new ArgumentNullException("key cannot be null or white space."); }
        ...
        ///     <c>false</c>.
        /// </returns>
        /// <exception cref="System.ArgumentNullException">key cannot be null or white space.</exception>
