...
namespace Bugger.Applications.ViewModels
{
    ...
    public class FloatingViewModel : ViewModel<IFloatingView>
    {
            ...
            : base(view)
        {
            ...
            AddWeakEventListener(this.dataService, DataServiceCollectionChanged);
        }

        #region Properties
        public int RedBugsCount
        {
            get { return this.dataService.RedBugs.Count; }
        }

        public int YellowBugsCount
        {
            get { return this.dataService.YellowBugs.Count; }
        }
        ...
        private void DataServiceCollectionChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == "RedBugs")
            {
                RaisePropertyChanged("RedBugsCount");
            }
            else if (e.PropertyName == "YellowBugs")
            {
                RaisePropertyChanged("YellowBugsCount");
            }
        }
        #endregion
        #endregion
