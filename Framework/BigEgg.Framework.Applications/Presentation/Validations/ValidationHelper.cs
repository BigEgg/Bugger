...
namespace BigEgg.Framework.Applications.Presentation.Validations
{
    ...
    public static class ValidationHelper
    {
        ...
        /// </summary>
        public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.RegisterAttached("IsEnable",
            typeof(bool), typeof(ValidationHelper), new PropertyMetadata(false, IsEnabledChangedCallback));
        ...
        public static readonly DependencyProperty IsValidProperty = DependencyProperty.RegisterAttached("IsValid",
            typeof(bool), typeof(ValidationHelper), new PropertyMetadata(true, IsValidChangedCallback));
        ...
        /// <summary>
        /// Sets a value that indicates whether the object is valid.
        /// </summary>
        /// <param name="obj">The object to set the value to.</param>
        /// <param name="value">if set to <c>true</c> then theobject is validt.</param>
        ...
        private static void CheckBindingMode(BindingMode mode)
        {
